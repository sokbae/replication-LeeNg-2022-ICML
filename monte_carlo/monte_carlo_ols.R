...
# Date: June 13, 2022
# Note: The number of replication is set as "nrep <- 10" for checking the code,
#       but it needs to be changed to "nrep <- 5000"  for replication purposes.
...
m <- 500
d <- 5
nrep <- 10 # This needs to be changed to "nrep <- 5000"  for replication.
alpha <- 0.05
cv <- qnorm(1 - alpha/2)
